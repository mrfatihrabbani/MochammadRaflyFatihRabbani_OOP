...
import com.fatih.frontend.commands.Command;
import com.fatih.frontend.commands.JetpackCommand;
import com.fatih.frontend.commands.RestartCommand;
import com.fatih.frontend.factories.ObstacleFactory;
import com.fatih.frontend.observers.ScoreUIObserver;
...
public class Main extends Game {
    ...
    // This value is changed to be consistent with the main file
    ...
    // resetGame() is not called from within RestartCommand, so this method is
    // may not be used if reset logic is already in the command.
    private void resetGame() {
        ...
        lastLoggedScore = -1; // Reset tracker logging
